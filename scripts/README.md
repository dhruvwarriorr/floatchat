...
4. `test_parser_reliability.py`: run the frozen 59-query parser suite with the provider disabled and, when explicitly requested, provider-enabled modes; the same report also exercises simulated failure and five API scenarios.
